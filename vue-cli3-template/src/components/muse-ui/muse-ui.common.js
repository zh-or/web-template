  ...
  watch: {
    open: function open(newValue) {
      ...
      this.$nextTick(function () {
        ...
        var dialogEl = _this2.$refs.dialog;
        if (!dialogEl) return;
        dialogEl.focus();
      });
    }
