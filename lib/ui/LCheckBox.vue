<template>
    ...
    >
        ...
        >
            ...
            <input
                  v-if="props.trueLabel || props.falseLabel"
        ...
        <span class="el-checkbox__label" v-if="$slots.default || props.label">
...
<script setup>
    ...
    let checkboxSize = computed(() => props.size);
    let isDisabled = computed(() => props.disabled);
    let isChecked = computed(() => model.value);
